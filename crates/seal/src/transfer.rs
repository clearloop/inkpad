...
/// AtLeat32Bits
#[host(seal0)]
pub fn seal_value_transferred(out_ptr: u32, out_len_ptr: u32) -> Result<Value> {
...
#[host(seal0)]
pub fn seal_caller(out_ptr: u32, out_len_ptr: u32) -> Result<Value> {
...
/// space at `out_ptr` is less than the size of the value a trap is triggered.
#[host(seal0)]
pub fn seal_address(out_ptr: u32, out_len_ptr: u32) -> Result<Value> {
...
#[host(seal0)]
pub fn seal_balance(out_ptr: u32, out_len_ptr: u32) -> Result<Value> {
...
/// space at `out_ptr` is less than the size of the value a trap is triggered.
#[host(seal0)]
pub fn seal_now(out_ptr: u32, out_len_ptr: u32) -> Result<Value> {
...
/// The data is encoded as T::Balance.
#[host(seal0)]
pub fn seal_minimum_balance(out_ptr: u32, out_len_ptr: u32) -> Result<Value> {
