...
#[host(seal0)]
pub fn seal_input(out_ptr: u32, out_len_ptr: u32) -> Result<Value> {
...
#[host(seal0)]
pub fn seal_return(flags: u32, data_ptr: u32, data_len: u32) -> Result<Value> {
...
#[host(seal0)]
pub fn seal_terminate(beneficiary_ptr: u32, beneficiary_len: u32) -> Result<Value> {
